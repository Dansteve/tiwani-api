...
`0013` (account soft-delete) and `0014` (the subscription + entitlement foundation)
...
direct-Postgres path when the feature goes live. `0014` additionally has no live Stripe
